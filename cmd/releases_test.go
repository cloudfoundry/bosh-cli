		...
		It("lists releases", func() {
			releases := []boshdir.Release{
				&fakedir.FakeRelease{
					...
					RepositoryStub:         func() string { return "repository1" },
				...
				&fakedir.FakeRelease{
					...
					RepositoryStub:         func() string { return "repository2" },
				...
				Rows: [][]boshtbl.Value{
					{
						...
						boshtbl.NewValueString("repository1"),
					},
					{
						boshtbl.NewValueString("rel1"),
						boshtbl.NewValueSuffix(
					...
					},
					{
						...
						boshtbl.NewValueString("repository2"),
					},
					{
						boshtbl.NewValueString("rel2"),
						boshtbl.NewValueSuffix(
