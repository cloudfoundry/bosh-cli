...
import (
	...
	mock_cloud "github.com/cloudfoundry/bosh-cli/v6/cloud/mocks"
	bicmd "github.com/cloudfoundry/bosh-cli/v6/cmd"
	. "github.com/cloudfoundry/bosh-cli/v6/cmd/opts"
	biconfig "github.com/cloudfoundry/bosh-cli/v6/config"
	mock_config "github.com/cloudfoundry/bosh-cli/v6/config/mocks"
	bicpirel "github.com/cloudfoundry/bosh-cli/v6/cpi/release"
	"github.com/cloudfoundry/bosh-cli/v6/deployment"
	bideplmanifest "github.com/cloudfoundry/bosh-cli/v6/deployment/manifest"
	fakebideplmanifest "github.com/cloudfoundry/bosh-cli/v6/deployment/manifest/manifestfakes"
	fakebideplval "github.com/cloudfoundry/bosh-cli/v6/deployment/manifest/manifestfakes"
	mock_deployment "github.com/cloudfoundry/bosh-cli/v6/deployment/mocks"
	bidepltpl "github.com/cloudfoundry/bosh-cli/v6/deployment/template"
	fakebidepltpl "github.com/cloudfoundry/bosh-cli/v6/deployment/template/templatefakes"
	fakebivm "github.com/cloudfoundry/bosh-cli/v6/deployment/vm/fakes"
	mock_vm "github.com/cloudfoundry/bosh-cli/v6/deployment/vm/mocks"
	...
	fakebiinstallmanifest "github.com/cloudfoundry/bosh-cli/v6/installation/manifest/fakes"
	mock_install "github.com/cloudfoundry/bosh-cli/v6/installation/mocks"
	bitarball "github.com/cloudfoundry/bosh-cli/v6/installation/tarball"
	mock_registry "github.com/cloudfoundry/bosh-cli/v6/registry/mocks"
	boshrel "github.com/cloudfoundry/bosh-cli/v6/release"
	bireljob "github.com/cloudfoundry/bosh-cli/v6/release/job"
	birelmanifest "github.com/cloudfoundry/bosh-cli/v6/release/manifest"
	fakebirel "github.com/cloudfoundry/bosh-cli/v6/release/releasefakes"
	...
	fakebirelsetmanifest "github.com/cloudfoundry/bosh-cli/v6/release/set/manifest/fakes"
	bistemcell "github.com/cloudfoundry/bosh-cli/v6/stemcell"
	mock_stemcell "github.com/cloudfoundry/bosh-cli/v6/stemcell/mocks"
