...
// Source: github.com/cloudfoundry/bosh-init/installation (interfaces: Installation,Installer,InstallerFactory,Uninstaller,JobResolver,PackageCompiler,JobRenderer)
