...
type FakeDeployment struct {
	...
	ExportReleaseStub        func(director.ReleaseSlug, director.OSVersionSlug, []string, bool) (director.ExportReleaseResult, error)
...
func (fake *FakeDeployment) ExportRelease(arg1 director.ReleaseSlug, arg2 director.OSVersionSlug, arg3 []string, arg4 bool) (director.ExportReleaseResult, error) {
	var arg3Copy []string
	if arg3 != nil {
	...
	fake.recordInvocation("ExportRelease", []interface{}{arg1, arg2, arg3Copy, arg4})
	fake.exportReleaseMutex.Unlock()
	if fake.ExportReleaseStub != nil {
		return fake.ExportReleaseStub(arg1, arg2, arg3, arg4)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
...
func (fake *FakeDeployment) ExportReleaseCalls(stub func(director.ReleaseSlug, director.OSVersionSlug, []string, bool) (director.ExportReleaseResult, error)) {
	fake.exportReleaseMutex.Lock()
	defer fake.exportReleaseMutex.Unlock()
	fake.ExportReleaseStub = stub
}

func (fake *FakeDeployment) ExportReleaseArgsForCall(i int) (director.ReleaseSlug, director.OSVersionSlug, []string, bool) {
	fake.exportReleaseMutex.RLock()
	defer fake.exportReleaseMutex.RUnlock()
