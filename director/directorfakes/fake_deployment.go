...
type FakeDeployment struct {
	...
	VariableCertsStub        func() ([]director.VariableCertResult, error)
	variableCertsMutex       sync.RWMutex
	variableCertsArgsForCall []struct {
	}
	variableCertsReturns struct {
		result1 []director.VariableCertResult
		result2 error
	}
	variableCertsReturnsOnCall map[int]struct {
		result1 []director.VariableCertResult
		result2 error
	}
...
func (fake *FakeDeployment) VariableCerts() ([]director.VariableCertResult, error) {
	fake.variableCertsMutex.Lock()
	ret, specificReturn := fake.variableCertsReturnsOnCall[len(fake.variableCertsArgsForCall)]
	fake.variableCertsArgsForCall = append(fake.variableCertsArgsForCall, struct {
	}{})
	fake.recordInvocation("VariableCerts", []interface{}{})
	fake.variableCertsMutex.Unlock()
	if fake.VariableCertsStub != nil {
		return fake.VariableCertsStub()
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	fakeReturns := fake.variableCertsReturns
	return fakeReturns.result1, fakeReturns.result2
}

func (fake *FakeDeployment) VariableCertsCallCount() int {
	fake.variableCertsMutex.RLock()
	defer fake.variableCertsMutex.RUnlock()
	return len(fake.variableCertsArgsForCall)
}

func (fake *FakeDeployment) VariableCertsCalls(stub func() ([]director.VariableCertResult, error)) {
	fake.variableCertsMutex.Lock()
	defer fake.variableCertsMutex.Unlock()
	fake.VariableCertsStub = stub
}

func (fake *FakeDeployment) VariableCertsReturns(result1 []director.VariableCertResult, result2 error) {
	fake.variableCertsMutex.Lock()
	defer fake.variableCertsMutex.Unlock()
	fake.VariableCertsStub = nil
	fake.variableCertsReturns = struct {
		result1 []director.VariableCertResult
		result2 error
	}{result1, result2}
}

func (fake *FakeDeployment) VariableCertsReturnsOnCall(i int, result1 []director.VariableCertResult, result2 error) {
	fake.variableCertsMutex.Lock()
	defer fake.variableCertsMutex.Unlock()
	fake.VariableCertsStub = nil
	if fake.variableCertsReturnsOnCall == nil {
		fake.variableCertsReturnsOnCall = make(map[int]struct {
			result1 []director.VariableCertResult
			result2 error
		})
	}
	fake.variableCertsReturnsOnCall[i] = struct {
		result1 []director.VariableCertResult
		result2 error
	}{result1, result2}
}
