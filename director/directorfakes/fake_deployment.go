...
type FakeDeployment struct {
	...
	VariablesStub        func(string) ([]director.VariableResult, error)
...
func (fake *FakeDeployment) Variables(arg1 string) ([]director.VariableResult, error) {
...
func (fake *FakeDeployment) VariablesArgsForCall(i int) string {
	fake.variablesMutex.RLock()
	defer fake.variablesMutex.RUnlock()
	return fake.variablesArgsForCall[i].arg1
}
...
func (fake *FakeDeployment) VariableCerts() ([]director.VariableCertResult, error) {
	...
	if fake.VariableCertsStub != nil {
		...
		return fake.variableCertsReturns.result1, fake.variableCertsReturns.result2
	}
}
