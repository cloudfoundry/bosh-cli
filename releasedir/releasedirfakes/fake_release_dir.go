...
type FakeReleaseDir struct {
	...
	NextDevVersionStub        func(name string, timestamp bool) (version.Version, error)
	...
	NextFinalVersionStub        func(name string) (version.Version, error)
	...
	LastReleaseStub        func() (release.Release, error)
	...
	BuildReleaseStub        func(name string, version version.Version, force bool) (release.Release, error)
	...
	FinalizeReleaseStub        func(release release.Release, force bool) error
	...
	BuildReleaseArchiveStub        func(release.Release) (string, error)
...
func (fake *FakeReleaseDir) NextDevVersion(name string, timestamp bool) (version.Version, error) {
...
func (fake *FakeReleaseDir) NextFinalVersion(name string) (version.Version, error) {
...
func (fake *FakeReleaseDir) LastRelease() (release.Release, error) {
...
func (fake *FakeReleaseDir) LastReleaseReturns(result1 release.Release, result2 error) {
...
func (fake *FakeReleaseDir) BuildReleaseArchive(arg1 release.Release) (string, error) {
...
func (fake *FakeReleaseDir) BuildReleaseArchiveArgsForCall(i int) release.Release {
	fake.buildReleaseArchiveMutex.RLock()
	defer fake.buildReleaseArchiveMutex.RUnlock()
