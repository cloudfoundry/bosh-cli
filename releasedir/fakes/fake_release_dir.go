...
type FakeReleaseDir struct {
	...
	LastReleaseStub        func() (boshrel.Release, error)
	...
	BuildReleaseArchiveStub        func(boshrel.Release) (string, error)
...
func (fake *FakeReleaseDir) LastRelease() (boshrel.Release, error) {
...
func (fake *FakeReleaseDir) LastReleaseReturns(result1 boshrel.Release, result2 error) {
...
func (fake *FakeReleaseDir) BuildReleaseArchive(arg1 boshrel.Release) (string, error) {
...
func (fake *FakeReleaseDir) BuildReleaseArchiveArgsForCall(i int) boshrel.Release {
	fake.buildReleaseArchiveMutex.RLock()
	defer fake.buildReleaseArchiveMutex.RUnlock()
