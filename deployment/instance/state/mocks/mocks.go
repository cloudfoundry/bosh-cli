...
// Source: github.com/cloudfoundry/bosh-cli/v6/deployment/instance/state (interfaces: BuilderFactory,Builder,State)
...
import (
	...
	state "github.com/cloudfoundry/bosh-cli/v6/deployment/instance/state"
