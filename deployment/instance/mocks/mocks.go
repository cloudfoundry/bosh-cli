...
func (_m *MockInstance) WaitUntilReady(_param0 manifest.Registry, _param1 manifest.SSHTunnel, _param2 ui.Stage) error {
...
func (_m *MockManager) Create(_param0 string, _param1 int, _param2 manifest0.Manifest, _param3 stemcell.CloudStemcell, _param4 manifest.Registry, _param5 manifest.SSHTunnel, _param6 ui.Stage) (instance.Instance, []disk.Disk, error) {
