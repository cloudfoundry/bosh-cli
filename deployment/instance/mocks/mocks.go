...
// Source: github.com/cloudfoundry/bosh-init/deployment/instance (interfaces: Instance,Manager)
...
func (_m *MockInstance) UpdateDisks(_param0 manifest0.Manifest, _param1 ui.Stage) ([]disk.Disk, error) {
...
func (_m *MockInstance) UpdateJobs(_param0 manifest0.Manifest, _param1 ui.Stage) error {
...
func (_m *MockInstance) WaitUntilReady(_param0 manifest.Registry, _param1 ui.Stage) error {
...
func (_m *MockManager) Create(_param0 string, _param1 int, _param2 manifest0.Manifest, _param3 stemcell.CloudStemcell, _param4 manifest.Registry, _param5 ui.Stage) (instance.Instance, []disk.Disk, error) {
