...
// Source: github.com/cloudfoundry/bosh-init/deployment (interfaces: Deployment,Factory,Deployer,Manager,ManagerFactory)
...
func (_m *MockDeployer) Deploy(_param0 cloud.Cloud, _param1 manifest0.Manifest, _param2 stemcell.CloudStemcell, _param3 manifest.Registry, _param4 manifest.SSHTunnel, _param5 vm.Manager, _param6 blobstore.Blobstore, _param7 ui.Stage) (deployment.Deployment, error) {
