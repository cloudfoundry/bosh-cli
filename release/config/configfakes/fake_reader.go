...
func (fake *FakeReader) Read(arg1 string) (*config.Config, error) {
	fake.readMutex.Lock()
...
func (fake *FakeReader) ReadReturns(result1 *config.Config, result2 error) {
	fake.ReadStub = nil
...
func (fake *FakeReader) ReadReturnsOnCall(i int, result1 *config.Config, result2 error) {
	fake.ReadStub = nil
