...
// Source: github.com/cloudfoundry/bosh-micro-cli/release (interfaces: Manager,Extractor,Resolver)
...
func (_mr *_MockManagerRecorder) FindByName(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FindByName", arg0)
}
...
func (_m *MockResolver) Verify() error {
	ret := _m.ctrl.Call(_m, "Verify")
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockResolverRecorder) Verify() *gomock.Call {
