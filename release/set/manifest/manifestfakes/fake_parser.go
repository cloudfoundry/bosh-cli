...
type FakeParser struct {
	ParseStub        func(string, template.Variables, patch.Op) (manifest.Manifest, error)
...
func (fake *FakeParser) Parse(arg1 string, arg2 template.Variables, arg3 patch.Op) (manifest.Manifest, error) {
...
func (fake *FakeParser) ParseCalls(stub func(string, template.Variables, patch.Op) (manifest.Manifest, error)) {
	fake.parseMutex.Lock()
	defer fake.parseMutex.Unlock()
	fake.ParseStub = stub
}

func (fake *FakeParser) ParseArgsForCall(i int) (string, template.Variables, patch.Op) {
	fake.parseMutex.RLock()
	defer fake.parseMutex.RUnlock()
