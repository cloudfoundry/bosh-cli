...
type FakeValidator struct {
	ValidateStub        func(manifest.Manifest) error
...
func (fake *FakeValidator) Validate(arg1 manifest.Manifest) error {
...
func (fake *FakeValidator) ValidateCalls(stub func(manifest.Manifest) error) {
	fake.validateMutex.Lock()
	defer fake.validateMutex.Unlock()
	fake.ValidateStub = stub
}

func (fake *FakeValidator) ValidateArgsForCall(i int) manifest.Manifest {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
