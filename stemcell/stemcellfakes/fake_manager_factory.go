...
type FakeManagerFactory struct {
	NewManagerStub        func(cloud.Cloud) stemcell.Manager
	newManagerMutex       sync.RWMutex
	newManagerArgsForCall []struct {
		arg1 cloud.Cloud
	}
	newManagerReturns struct {
		result1 stemcell.Manager
	}
	invocations      map[string][][]interface{}
	invocationsMutex sync.RWMutex
}

func (fake *FakeManagerFactory) NewManager(arg1 cloud.Cloud) stemcell.Manager {
...
func (fake *FakeManagerFactory) NewManagerReturns(result1 stemcell.Manager) {
...
var _ stemcell.ManagerFactory = new(FakeManagerFactory)
