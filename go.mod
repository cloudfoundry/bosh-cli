...
require (
	...
	github.com/cloudfoundry/bosh-agent/v2 v2.736.0
	github.com/cloudfoundry/bosh-davcli v0.0.403
	github.com/cloudfoundry/bosh-gcscli v0.0.284
	github.com/cloudfoundry/bosh-s3cli v0.0.355
