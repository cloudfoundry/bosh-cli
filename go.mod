...
require (
	...
	code.cloudfoundry.org/workpool v0.0.0-20241001204435-8c0f2d16a840
	...
	github.com/cloudfoundry/bosh-gcscli v0.0.253
	github.com/cloudfoundry/bosh-s3cli v0.0.322
