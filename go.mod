...
require (
	...
	code.cloudfoundry.org/workpool v0.0.0-20241026002256-14280f1325fc
	...
	github.com/cloudfoundry/bosh-gcscli v0.0.255
	github.com/cloudfoundry/bosh-s3cli v0.0.324
